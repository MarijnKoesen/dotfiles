...
if has("gui_running") || &t_Co == 88 || &t_Co == 256
    ...
    call <SID>X("NonText", "333333", "4D4D4D", "bold")         "Background
    ...
    call <SID>X("Title", "d5c5c", "", "")
    call <SID>X("Visual", "6b8e23", "f0e68c", "reverse")
    call <SID>X("VisualNOS", "6b8e23", "f0e68c", "reverse")
    "VisualNOS
    ...
    call <SID>X("Constant", "ffa0a0", "", "") " Constant
        call <SID>X("Identifier", "A9F999", "", "none") " php: $var 
        call <SID>X("Statement", "f0e68c", "", "bold") " call
        call <SID>X("PreProc", "DF9A97", "", "") " function / require_once
